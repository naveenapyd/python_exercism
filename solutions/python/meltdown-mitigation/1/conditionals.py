...
def reactor_efficiency(voltage, current, theoretical_max_power):
    ...
    if(generated_power / theoretical_max_power * 100 >= 80):
        return 'green'
    elif(generated_power / theoretical_max_power * 100 >= 60 and generated_power / theoretical_max_power * 100 < 80):
        return 'orange'
    elif(generated_power / theoretical_max_power * 100 >= 30 and generated_power / theoretical_max_power * 100 < 60):
        return 'red'
    else:
        return 'black'
